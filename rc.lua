...
local mem_icon = wibox.widget.imagebox(beautiful.mem)
local mem = lain.widget.mem({
  settings = function()
    widget:set_markup(lain.util.markup.font(beautiful.font, " " .. mem_now.perc .. "% "))
  end
})

local fs_icon = wibox.widget.imagebox(beautiful.fs)
local fs = lain.widget.fs({
  settings = function()
    widget:set_markup(lain.util.markup.font(beautiful.font, " " .. fs_now.available_gb .. "GB "))
  end
})
  ...
  settings = function()
    ...
    if bat_now.status ~= "N/A" then
      ...
      elseif tonumber(bat_now.perc) <= 5 then
        widget:set_markup(lain.util.markup.font(beautiful.font, "   " .. bat_now.perc .. "% "))
      elseif tonumber(bat_now.perc) <= 12 then
        widget:set_markup(lain.util.markup.font(beautiful.font, " ▁ " .. bat_now.perc .. "% "))
      elseif tonumber(bat_now.perc) <= 25 then
        widget:set_markup(lain.util.markup.font(beautiful.font, " ▂ " .. bat_now.perc .. "% "))
      elseif tonumber(bat_now.perc) <= 37 then
        widget:set_markup(lain.util.markup.font(beautiful.font, " ▃ " .. bat_now.perc .. "% "))
      elseif tonumber(bat_now.perc) <= 50 then
        widget:set_markup(lain.util.markup.font(beautiful.font, " ▄ " .. bat_now.perc .. "% "))
      elseif tonumber(bat_now.perc) <= 62 then
        widget:set_markup(lain.util.markup.font(beautiful.font, " ▅ " .. bat_now.perc .. "% "))
      elseif tonumber(bat_now.perc) <= 75 then
        widget:set_markup(lain.util.markup.font(beautiful.font, " ▆ " .. bat_now.perc .. "% "))
      elseif tonumber(bat_now.perc) <= 87 then
        widget:set_markup(lain.util.markup.font(beautiful.font, " ▇ " .. bat_now.perc .. "% "))
      else
        widget:set_markup(lain.util.markup.font(beautiful.font, " █ " .. bat_now.perc .. "% "))
      end
      ...
      widget:set_markup()
      bat_icon:set_image(beautiful.bat_ac)
    end
  end
})
...
awful.screen.connect_for_each_screen(function(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            sep(beautiful.red, beautiful.darkyellow),
            wibox.container.background(wibox.container.margin(wibox.widget {mem_icon, mem, layout = wibox.layout.align.horizontal }, 3, 3), beautiful.darkyellow),
            sep(beautiful.darkyellow, beautiful.green),
            wibox.container.background(volumecfg.widget, beautiful.green),
            ...
            sep(beautiful.cyan, beautiful.blue),
            ...
            sep(beautiful.magenta, beautiful.darkmagenta),
            wibox.container.background(s.mylayoutbox,beautiful.darkmagenta),
        },
    }
end)
-- }}}
...
--Adding media control keys
globalkeys = awful.util.table.join(globalkeys,
    awful.key({}, "XF86AudioRaiseVolume", function() awful.util.spawn("amixer -D pulse set Master 1%+") end),
    awful.key({}, "XF86AudioLowerVolume", function() awful.util.spawn("amixer -D pulse set Master 1%-") end),
    awful.key({}, "XF86AudioMute",        function() awful.util.spawn("amixer -D pulse set Master toggle") end)
)

--Adding brightness control keys
globalkeys = awful.util.table.join(globalkeys,
    awful.key({}, "XF86MonBrightnessDown", function ()
      awful.util.spawn("bright -d 5") end),
    awful.key({}, "XF86MonBrightnessUp", function ()
      awful.util.spawn("bright -i 5") end)
)
